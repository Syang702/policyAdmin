  ...
  <div class="transfer">
    ...
    >
      ...
      >
        ...
        <el-form-item label="转账币种" prop="currency_id">
          <el-select v-model="cash.currency_id">
            <el-option
              ...
              :label="currency.name"
              :value="currency.id"
            >{{currency.name}}</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="转账基数" prop="cardinal_number">
          <el-input v-model="cash.cardinal_number" />
        </el-form-item>
        <el-form-item label="最小转账值" prop="min">
          <el-input v-model="cash.min" />
        </el-form-item>
        <el-form-item label="最大转账值" prop="max">
