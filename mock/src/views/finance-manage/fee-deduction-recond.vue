  ...
  <div class="recond app-container">
    ...
    >
     <el-table-column align="center" label="序号" type="index" width="50"></el-table-column>
      ...
      <el-table-column label="扣费币种" align="center">
        <template slot-scope="scope">{{ scope.row.currency_name }}</template>
      </el-table-column>
      <el-table-column label="扣费时间" align="center">
...
<script>
import { deductionRecond  } from "@/api/fiance-manage.js";
...
export default {
  ...
  methods: {
    getRecondList() {
      ...
      deductionRecond(this.listQuery).then(response => {
